...
installed both patch sets to their super secure lab machines, with TPM-sealed
disk encryption protecting their latest research (flag).
...
<details><summary>Show hint #2</summary>Command entered into /proc/sys/kernel/gimme_shell will be run by initrd.
...
* [linux-headers.tar.zst](files/linux-headers.tar.zst)

* [run.tar.zst](files/run.tar.zst)

* [vmlinux.zst](files/vmlinux.zst)
