...
finding their secrets. They found PwnySIG Inc.'s server and was able to detach
its hard drive and replace the kernel with a backdoor-ed kernel.
...
leave a signed lua interpreter wide open. Maybe they can bypass secure
boot through that?
